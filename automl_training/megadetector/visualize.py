'''
This script produces visualizations of all the label files.
It can also make label files without manual checking.
'''
import os
import cv2
import json
